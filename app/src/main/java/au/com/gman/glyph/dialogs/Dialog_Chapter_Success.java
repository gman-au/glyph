 ...
 * @author gub
 */
public class Dialog_Chapter_Success extends Dialog {
    
    public Dialog_Chapter_Success(ColorX C1, ColorX C2, String T, RectF R, Typeface font, Library.Dialogs Type, Panel xP) {
        super(C1, C2, T, R, font, Type);
        buttons.add(new DialogButton(Library.getScaledRect(rect, 0.1f, 0.75f, 0.7f, 0.1f), C1, C2, xP.getLocaleString(au.com.gman.glyph.R.string.button_next), Button.NEXT_CHAPTER, font));
